...
package webit.android.shanti.customViews.slideuppanel;
...
public class ViewDragHelper {
     ...
     * The callback's {@link webit.android.shanti.customViews.slideuppanel.ViewDragHelper.Callback#onEdgeTouched(int, int)} and
     * {@link webit.android.shanti.customViews.slideuppanel.ViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be invoked
     ...
     * but {@link webit.android.shanti.customViews.slideuppanel.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)} will not be asked permission to
     * capture this view.
     *
     ...
     * The child order is determined using {@link webit.android.shanti.customViews.slideuppanel.ViewDragHelper.Callback#getOrderedChildIndex(int)}.
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
